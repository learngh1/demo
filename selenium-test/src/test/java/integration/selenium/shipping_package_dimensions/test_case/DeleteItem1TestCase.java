 ...
 */
public class DeleteItem1TestCase implements SeleniumTestCase {
    @Override
    public void test(WebDriver driver, Map<String, String> variables) throws Exception {
        ...
        Thread.sleep(1000);
        assertFalse(SPDTestUtil.isElementPresent(driver, By.xpath("//div/div/table/tbody/tr/td/div[contains(text(),'Item_1_for_test_spd')]")));
    }
}
